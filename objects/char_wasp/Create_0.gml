...
name = "John Wauce"
title = "The Offender"
alibi = "Were you when the barfight broke out?^Bzzz I was preoccupied during the chaos bzzz flying through the bar and knocking stuff off of the walls. Bzzz I don't know why I was doing it, I don't work well under stress, especially not after a night of drinking."
dialogue = "Why'd you do that for?^Bzzzz some call me a sex pest bzzz, but that's not what this is about. I am simply a bug who enjoys putting his body on display for others to enjoy, bzzzz. Art does not need consent bzzz. Unfortunately not everybody thinks that, and when I showed off to the bartender things got bzzzz ugly."
guilty = -1
bloodtype = c_green
particle = false
sound = snd_buzz
